...
<head>
    ...
    <style>
        ...
        .galeri-card:hover .galeri-img-wrap::after {
            opacity: 1;
        }
        ...
        #modalEnlarge.show .modal-enlarge-content {
            transform: scale(1);
        }
...
<body>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content">
                        ...
                        <li><a href="galeri.php"
                                style="color:var(--primary-green)!important;font-weight:bold;">Galeri</a></li>
                    </ul>
                </li>
    ...
    <section>
        <div class="premium-hero">
            ...
            <p>Rangkuman bingkai dokumentatif terbaik sepanjang perjalanan aktivitas, dedikasi, dan memori masa sekolah
                di lingkungan nyata kami.</p>
        </div>
        ...
        <div class="premium-grid">
            <?php foreach ($galeri as $item):
                ...
                <div class="galeri-card"
                    onclick="bukaEnlargeModal('<?php echo $foto_src; ?>', '<?php echo addslashes($judul); ?>', '<?php echo addslashes($desk); ?>')">
