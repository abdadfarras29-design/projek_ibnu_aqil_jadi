        ...
        <div class="share-section">
            ...
            <a class="share-btn share-wa"
                ...
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <path
                        d="M12 0C5.373 0 0 5.373 0 12c0 2.138.564 4.138 1.541 5.875L.057 23.93l6.23-1.459A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.961 0-3.785-.538-5.343-1.47l-.383-.228-3.983.932.974-3.87-.249-.398A9.96 9.96 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
                </svg>
                WhatsApp
            </a>
            <a class="share-btn share-fb"
                href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($page_url); ?>" target="_blank"
                rel="noopener">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                    <path
                    ...
                    <a href="detail-berita.php?id=<?php echo $rel['id']; ?>" class="related-card">
                        <?php if (!empty($rel['foto'])): ?>
                            <img src="<?php echo htmlspecialchars($rel['foto']); ?>"
                                alt="<?php echo htmlspecialchars($rel['judul']); ?>" class="related-img"
